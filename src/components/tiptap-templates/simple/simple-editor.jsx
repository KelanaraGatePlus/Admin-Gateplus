...
export function SimpleEditor({ onChange, initialContent }) {
    ...
    const editor = useEditor({
        ...
        // Jika ada initialContent (mode edit), gunakan itu. Fallback ke defaultContent.
    ...
    return (
        <div className="outline-black outline-2 rounded-xl overflow-hidden">
