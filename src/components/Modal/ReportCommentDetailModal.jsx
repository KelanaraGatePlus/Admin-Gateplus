...
export default function ReportCommentDetailModal({ report, onClose }) {
    ...
    // ✅ DIPERBAIKI: Ubah dari SUSPEND_COMMENTER 
                                ...
                                <div className="border-t border-gray-200 pt-6 mt-6 bg-gray-50 p-6 rounded-lg">
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            {/* ✅ DIPERBAIKI */}
                                            {formData.actionTaken === 'SUSPEND_COMMENTER' && formData.suspendDuration && (
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60] p-4">
                    <div className="bg-white rounded-lg max-w-md w-full shadow-2xl">
                        <div className="p-6 border-b border-gray-200">
                            <h3 className="text-lg font-bold text-gray-900">Durasi Suspend User</h3>
                        </div>
                        ...
                        <div className="flex justify-end gap-3 p-6 border-t border-gray-200 bg-gray-50">
                            ...
                            <button
                                ...
                                className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium text-sm shadow-sm disabled:opacity-50"
                            >
                                Konfirmasi
                            </button>
                        </div>
